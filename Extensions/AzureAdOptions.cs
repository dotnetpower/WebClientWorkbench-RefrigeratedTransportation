...
namespace WebClientWorkbench.Extensions
{
    public class AzureAdOptions
    {
        ...
        /// <summary>
        /// Client Id (Application ID) of the WorkbenchListService, obtained from the Azure portal for that application
        /// </summary>
        public string WorkbenchResourceId { get; set; }

        /// <summary>
        /// Base URL of the WorkbenchListService
        /// </summary>
        public string WorkbenchBaseAddress { get; set; }
