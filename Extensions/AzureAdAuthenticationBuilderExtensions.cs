...
namespace WebClientWorkbench.Extensions
{
    public static class AzureAdAuthenticationBuilderExtensions
    {
        ...
        private class ConfigureAzureOptions : IConfigureNamedOptions<OpenIdConnectOptions>
        {
            ...
            /// WorkbenchController, to call AcquireTokenSilentAsync successfully.
            /// </summary>
            private async Task OnAuthorizationCodeReceived(AuthorizationCodeReceivedContext context)
            {
                // Acquire a Token for the Graph API and cache it using ADAL. In the WorkbenchController, we'll use the cache to acquire a token for the Workbench Blockchain API
